...
const producto = prompt(
  "Bienvenido al almacén, elija qué producto dentro del stock disponible quiere comprar:\n1. Manzanas\n2. Bananas\n3. Leche\n4. Pan\nSi quiere salir de esta ventana por favor escriba NO QUIERO NADA"
);

const productoSeleccionado = producto.toLowerCase();

if (productoSeleccionado === "no quiero nada") {
  ...
  switch (productoSeleccionado) {
    ...
    case "pan":
      ...
      break;
    default:
      alert("Producto no válido o no disponible.");
      break;
  }
  ...
  if (precioProducto !== undefined) {
    ...
    alert("El precio del producto no está definido.");
  }
}
